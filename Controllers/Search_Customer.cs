...
namespace C_OrderTaking_Api.Controllers
{
    ...
    [ApiController]
    public class Search_Customer : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<string>> GetDescSearch(string type, string desc)
        {
            ...
            var json1 = Newtonsoft.Json.JsonConvert.SerializeObject(dt);
            var jsont = new JavaScriptSerializer().DeserializeObject(json1);
            return Ok(new { jsont });
